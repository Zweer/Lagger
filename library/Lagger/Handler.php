...
abstract class Handler {
	...
	public function __construct(Eventspace $eventspace) {
	...
	public function addAction(Action $action, $tags = null, Tagger $tagger = null) {
	...
	public static function addInternalErrorAction(Action $action) {
		self::$internalErrorsActions[] = $action;
	}

	protected static function handleInternalError(Eventspace $eventspace, $type, $message) {
